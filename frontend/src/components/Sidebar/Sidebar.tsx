...
export default function Sidebar() {
    ...
    const navItems: NavItem[] = [
        { href: '/emanager/dashboard', label: 'Dashboard' },
        { href: '/emanager/userdetails', label: 'User Information' },
        { href: '/emanager/profile', label: 'User Profile' }
    ];

    const sidebarItems = [
        {
            href: '/emanager/dashboard',
            label: 'Dashboard',
            icon: (
        ...
        {
            href: '/emanager/profile',
            label: 'User Profile',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg>
            )
        },
        {
            href: '/emanager/updateprofile',
                        ...
                        <ul className="flex flex-col mt-4 font-medium rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                            {navItems.map((item) => {
                                ...
                                return (
                                    <li key={item.href}>
                                        <Link href={item.href}>
                                            <p className={`block px-3 py-2 rounded md:p-0 
                                                ${isActive 
                                                    ? 'bg-gray-100 text-blue-600 dark:text-blue-500 dark:bg-gray-700' 
