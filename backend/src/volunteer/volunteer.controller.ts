...
import { Controller, Get, Post, Body, Param, Put, Delete, UseGuards, NotFoundException, ValidationPipe, UsePipes, Query } from '@nestjs/common';
...
export class VolunteerController {
  ...
  async findAll(
    ...
    return this.volunteerService.findAll(sortBy, sortOrder);
  }
